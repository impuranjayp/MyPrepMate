...
<header>
        ...
        <nav>
            <ul class="nav-links">
                ...
                <li ><a class="nav-link" href="../Quiz/quiz_home.html">Quiz</a></li>
    ...
    <script src="elib-script.js"></script>

    <div>
        <br><center><h1>E-Books</h1></center>
        <br><center><a href="Cart.php" class="buttons">Go to Cart</a>
